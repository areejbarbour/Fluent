...
class BlockingTestsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (ctx) => QuestionBlockingTestsCubit(ctx.read<QuestionRepository>())
...
class _BlockingView extends StatelessWidget {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            right: -90.w,
            child: QuestionUI
                .glowingCircle(AppColors.orange, 280.w)
          ...
          Positioned(
            ...
            left: -100.w,
            child: QuestionUI
                .glowingCircle(AppColors.sky, 320.w)
                .animate(onPlay: (c) => c.repeat(reverse: true))
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                SizedBox(height: 12.h),
                Expanded(
                  child: BlocBuilder<QuestionBlockingTestsCubit,
                    ...
                    builder: (context, state) {
                      ...
                      if (state is QuestionBlockingTestsLoaded) {
                        return _buildLoaded(context, state.data.blockingTests);
                      }
  ...
  Widget _buildLoaded(BuildContext context, List<AffectedTest> tests) {
    return ListView(
      ...
      padding: EdgeInsets.symmetric(horizontal: 18.w),
      children: [
        _buildInfoBanner(tests.length).animate().fadeIn(duration: 400.ms).moveY(begin: 16, end: 0),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.block, color: AppColors.orange, size: 24.sp),
          ),
          SizedBox(width: 12.w),
          Expanded(
            child: Column(
              ...
              children: [
                Text("$count Published Test${count == 1 ? '' : 's'}",
                ...
                Text(
                  count > 0
                      ? "These tests are currently using this question. They must be unlinked before this question can be edited or deleted."
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.check_circle_outline,
                color: Colors.greenAccent.withOpacity(0.7), size: 64.sp),
            SizedBox(height: 12.h),
            Text("Nothing blocking",
                style: GoogleFonts.poppins(
                    ...
                    fontWeight: FontWeight.w600)),
            SizedBox(height: 6.h),
            Text("You can edit or delete this question freely.",
                style: GoogleFonts.poppins(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.assignment_outlined,
                color: AppColors.orange, size: 22.sp),
          ),
          SizedBox(width: 12.w),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(t.testableType ?? "Published Test",
                      style: GoogleFonts.poppins(
                          color: AppColors.yellow,
                          fontSize: 10.sp,
                          fontWeight: FontWeight.w700)),
